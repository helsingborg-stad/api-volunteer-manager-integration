        ...
        return [
            ...
            'labels'             => [
                ...
                'field_label_assignment_image'               => __('Assignment Image',
                    API_VOLUNTEER_MANAGER_INTEGRATION_TEXT_DOMAIN),
                'field_label_general_contact_name'           => __('Name',
                    API_VOLUNTEER_MANAGER_INTEGRATION_TEXT_DOMAIN),
                'field_label_general_organisation'           => __('Organisation',
                    API_VOLUNTEER_MANAGER_INTEGRATION_TEXT_DOMAIN),
                'field_label_general_contact_email'          => __('E-mail',
                    API_VOLUNTEER_MANAGER_INTEGRATION_TEXT_DOMAIN),
                'field_label_general_contact_phone'          => __('Phone',
                    API_VOLUNTEER_MANAGER_INTEGRATION_TEXT_DOMAIN),
                ...
                'field_label_public_contact_email'           => __('Public Contact Email',
                    API_VOLUNTEER_MANAGER_INTEGRATION_TEXT_DOMAIN),
                'field_label_public_contact_phone'           => __('Public Contact Phone',
                    API_VOLUNTEER_MANAGER_INTEGRATION_TEXT_DOMAIN),
